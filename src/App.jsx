...
function Certifications(){
  ...
  return(
    <section id="certifications" className="py-24 px-[5%]">
      ...
      <div ref={ref} className="reveal grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-14">
        ...
        <div className="bg-[var(--ink3)] border border-[var(--wire)] rounded-xl overflow-hidden hover:border-[rgba(255,107,43,0.3)] hover:-translate-y-1 transition-all"><div className="h-[3px] bg-gradient-to-r from-orange-500 to-amber-400"/><div className="p-7"><div className="flex items-center justify-between mb-4"><div className="font-mono text-[10px] tracking-[2px] text-amber-400 uppercase">UDEMY</div><div className="font-mono text-[10px] text-[var(--muted)]">Mar 12, 2026</div></div><div className="font-display text-2xl leading-snug tracking-[-0.5px] mb-2">Learn JAVA Programming — Beginner to Master</div><div className="text-sm text-[var(--muted)] mb-5">Abdul Bari · 61.5 total hours</div><div className="flex flex-wrap gap-1.5 mb-5">{["Java","OOP","DSA","Collections","Multithreading","JDBC"].map(t=><Tag key={t}>{t}</Tag>)}</div><a href="https://ude.my/UC-78f26b2c-790b-4a48-b9e0-de7706432f87" target="_blank" rel="noreferrer" className="font-mono text-[11px] text-[var(--or)] no-underline border border-[rgba(255,107,43,0.3)] px-3.5 py-1.5 rounded-sm hover:bg-[rgba(255,107,43,0.08)] transition-colors inline-flex">View Certificate ↗</a></div></div>
        <div className="bg-[var(--ink3)] border border-[var(--wire)] rounded-xl overflow-hidden hover:border-[rgba(255,107,43,0.3)] hover:-translate-y-1 transition-all"><div className="h-[3px] bg-gradient-to-r from-blue-500 to-cyan-400"/><div className="p-7"><div className="flex items-center justify-between mb-4"><div className="font-mono text-[10px] tracking-[2px] text-cyan-400 uppercase">UDEMY</div><div className="font-mono text-[10px] text-[var(--muted)]">Mar 12, 2026</div></div><div className="font-display text-2xl leading-snug tracking-[-0.5px] mb-2">Complete Web Development Course</div><div className="text-sm text-[var(--muted)] mb-5">Hitesh Choudhary · 100 total hours</div><div className="flex flex-wrap gap-1.5 mb-5">{["HTML","CSS","JavaScript","React","Node.js","MongoDB"].map(t=><Tag key={t}>{t}</Tag>)}</div><a href="https://ude.my/UC-29ac7381-a5ef-4be5-9bf3-5346e832bead" target="_blank" rel="noreferrer" className="font-mono text-[11px] text-[var(--or)] no-underline border border-[rgba(255,107,43,0.3)] px-3.5 py-1.5 rounded-sm hover:bg-[rgba(255,107,43,0.08)] transition-colors inline-flex">View Certificate ↗</a></div></div>
      </div>
    </section>
  );
}
